...
if (__name__ == '__main__'):
    ...
    for f in folds:
        folds_str += str(f)
    plans = 'nnUNetPlans'
    overwrite_plans = {'nnUNetTrainerV2_2': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_2_noMirror': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_lessMomentum_noMirror': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_2_structSeg_noMirror': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_2_structSeg': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_lessMomentum_noMirror_structSeg': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_FabiansResUNet_structSet_NoMirror': ['nnUNetPlans', 'nnUNetPlans_customClip'], 'nnUNetTrainerV2_FabiansResUNet_structSet': ['nnUNetPlans', 'nnUNetPlans_customClip']}
    trainers = (['nnUNetTrainer'] + ['nnUNetTrainerV2_2', 'nnUNetTrainerV2_lessMomentum_noMirror', 'nnUNetTrainerV2_2_noMirror', 'nnUNetTrainerV2_2_structSeg_noMirror', 'nnUNetTrainerV2_2_structSeg', 'nnUNetTrainerV2_lessMomentum_noMirror_structSeg', 'nnUNetTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder', 'nnUNetTrainerV2_FabiansResUNet_structSet_NoMirror', 'nnUNetTrainerV2_FabiansResUNet_structSet'])
    datasets = {'Task049_StructSeg2019_Task1_HaN_OAR': ('3d_fullres', '3d_lowres', '2d'), 'Task050_StructSeg2019_Task2_Naso_GTV': ('3d_fullres', '3d_lowres', '2d'), 'Task051_StructSeg2019_Task3_Thoracic_OAR': ('3d_fullres', '3d_lowres', '2d'), 'Task052_StructSeg2019_Task4_Lung_GTV': ('3d_fullres', '3d_lowres', '2d')}
