...
def get_company_count(*, area_code: List[str]=None, category: List[str]=None, reg_capital_range: List[Tuple[(int, int)]]=None, establish_time_range: List[Tuple[(int, int)]]=None, reg_status: List[str]=None, capital_unit: List[str]=None, company_type: List[str]=None, institution_type: List[str]=None, staff_num_range: List[Tuple[(int, int)]]=None, financing_round: List[str]=None, listed_type: List[str]=None, has_phone: bool=None, has_mobile: bool=None, has_email: bool=None, has_brand: bool=None, has_dishonest: bool=None, has_website: bool=None, has_chattel_mortage: bool=None, has_copyright: bool=None, has_soft_copyright: bool=None, is_high_tech_company: bool=None, is_tax_a_level: bool=None, is_general_taxpayer: bool=None, has_bid: bool=None) -> int:
    ...
    if reg_capital_range:
        reg_capital_range = [num for num_tuple in reg_capital_range for num in num_tuple]
    if establish_time_range:
        establish_time_range = [num for num_tuple in establish_time_range for num in num_tuple]
    if staff_num_range:
        staff_num_range = [num for num_tuple in staff_num_range for num in num_tuple]
    query = {'areaCodeSet': area_code, 'categoryGuobiao2017Set': category, 'regCapitalRangeSet': reg_capital_range, 'establishTimeRangeSet': establish_time_range, 'regStatusSet': reg_status, 'capitalUnitSet': capital_unit, 'companyTypeSet': company_type, 'institutionTypeSet': institution_type, 'staffNumRangeSet': staff_num_range, 'financingRoundList': financing_round, 'listedTypeSet': listed_type, 'hasPhone': has_phone, 'hasMobile': has_mobile, 'hasEmail': has_email, 'hasBrand': has_brand, 'hasDishonest': has_dishonest, 'hasWebSite': has_website, 'hasChattelMortage': has_chattel_mortage, 'hasCopyright': has_copyright, 'hasSoftCopyright': has_soft_copyright, 'isHighTechCompany': is_high_tech_company, 'taxLevel': is_tax_a_level, 'isGeneralTaxpayer': is_general_taxpayer, 'hasBid': has_bid}
