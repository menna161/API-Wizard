...
@click.option('-g', '--guess', is_flag=True, default=False, help='Guess title (first line of text).')
@click.option('-t', '--title', type=click.STRING, help='Title for Meta-ID creation.')
@click.option('-e', '--extra', type=click.STRING, help='Extra text for Meta-ID creation.')
