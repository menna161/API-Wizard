...
def __init__(self, registry_config: Optional[RegistryConfig], project: str, repo_path: Optional[Path]):
    ...
    self.cached_registry_proto_ttl = timedelta(seconds=(registry_config.cache_ttl_seconds if (registry_config.cache_ttl_seconds is not None) else 0))
