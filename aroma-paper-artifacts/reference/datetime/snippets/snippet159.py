...
from util.app_util import current_date, validate_date_str, current_hour, current_timestamp, datetime_str_timestamp, validate_time_str
    ...
    while True:
        ...
        if ((hour > 22) or (hour < 6)):
            ...
            if (config.SELL_TIME != ''):
                ...
                log.info('Starting...')
            while True:
                ticket_list = Ticket.search_stack(from_station=config.FROM_STATION, to_station=config.TO_STATION, train_date=config.DATE)
