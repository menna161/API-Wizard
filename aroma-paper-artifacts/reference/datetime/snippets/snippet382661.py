...
def test_timestamp_micros(self):
    ...
    self.assertEquals(p.convert(test_schema2, pytz.UTC.localize(datetime.datetime(2015, 5, 1, microsecond=123456))), 1430438400123456)
    offset_res = 1430452800123456
    self.assertEquals(p.convert(test_schema2, pytz.timezone('America/New_York').localize(datetime.datetime(2015, 5, 1, 0, 0, 0, microsecond=123456))), offset_res)
