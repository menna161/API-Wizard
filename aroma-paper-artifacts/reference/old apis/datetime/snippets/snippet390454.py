...
def generate_client_certs(domain, base_year, quiet=False):
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Good TLS Client Certificate'}, public_key)
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Expired TLS Client Certificate'}, public_key)
    builder.issuer = ca_cert
    builder.crl_url = crl_url
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Future TLS Client Certificate'}, public_key)
    builder.issuer = ca_cert
    builder.crl_url = crl_url
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Untrusted TLS Client Certificate'}, public_key)
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Weak TLS Client Certificate'}, public_key)
    builder.issuer = ca_cert
    builder.crl_url = crl_url
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Bad Key Usage TLS Client Certificate'}, public_key)
    builder.issuer = ca_cert
    builder.crl_url = crl_url
    builder.begin_date = datetime(base_year, 1, 1, 0, 0, 0, tzinfo=timezone.utc)
    builder.end_date = datetime((base_year + 3), 1, 1, 0, 0, 0, tzinfo=timezone.utc)
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'TLS Client Certificates Limited', 'common_name': 'Revoked TLS Client Certificate'}, public_key)
    builder.issuer = ca_cert
    builder.crl_url = crl_url
    builder.begin_date = datetime(base_year, 1, 1, 0, 0, 0, tzinfo=timezone.utc)
    builder.end_date = datetime((base_year + 3), 1, 1, 0, 0, 0, tzinfo=timezone.utc)
    ...
    crl_builder.add_certificate(revoked_certificate.serial_number, datetime(base_year, 1, 2, 0, 0, 0, tzinfo=timezone.utc), 'key_compromise')
