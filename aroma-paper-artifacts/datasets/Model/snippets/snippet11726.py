...
def test_snapshot_deployer(self):
    ...
    res = self.deployer.deploy_from_linked_clone(si=self.si, data_holder=deploy_from_template_details, vcenter_data_model=resource_context, logger=Mock(), reservation_id=Mock(), cancellation_context=cancellation_context)
