...
def create_model(data, lr_D, lr_G, beta1, initial_file):
    ...
    return Model(predict_real=predict_real, predict_fake=predict_fake, predict_mask=mask_fake, discrim_loss=discrim_loss, discrim_loss_final=discrim_loss_final, gen_loss_GAN=gen_loss_GAN, gen_loss_L1=gen_loss_L1, outputs=outputs, texture=texture, train=tf.group(gen_train, discrim_train, incr_global_step), l1_weight=l1_weight, global_step=global_step)
