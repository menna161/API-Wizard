...
def _setup_update_at_time(self, update_dttm: datetime, state: (str | None)=None, attrs: (MutableMapping[(str, Any)] | None)=None) -> None:
    'Setu up update at given time.'
    self._updates.append(Update(async_track_point_in_utc_time(self.hass, self._async_do_update, update_dttm), update_dttm, state, attrs))
