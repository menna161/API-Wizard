...
def __init__(self, _embsize: int, kernels_mu: List[float], kernels_sigma: List[float], att_heads: int, att_layer: int, att_ff_dim: int, max_length: int, use_diff_posencoding: bool, mix_hybrid_context: bool):
