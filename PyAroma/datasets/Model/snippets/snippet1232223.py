...
def main():
    ...
    full_tokenizer.model_max_length = 999999
        ...
        for i in x:
            ...
            for step in range((len(samples) // batch_size)):
                ...
                if (((overall_step + 1) % log_step) == 0):
                    ...
                    print('now time: {}:{}. Step {} of piece {} of epoch {}, loss {}'.format(datetime.now().hour, datetime.now().minute, (step + 1), piece_num, (epoch + 1), ((running_loss * gradient_accumulation) / (log_step / gradient_accumulation))))
                    running_loss = 0
                overall_step += 1
            piece_num += 1
