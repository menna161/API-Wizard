...
parser.add_argument('--preprocessed_data', default='./data/preprocessed/', type=str, dest='preprocessed_data', help='path to preprocessed_data')
parser.add_argument('--scored_data', default='./data/scored_data/', type=str, dest='scored_data', help='path to scored_data')
parser.add_argument('--model_path', default='./outputs/', type=str, dest='model_path', help='path to model')
