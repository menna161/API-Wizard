...
def _create_speed_arr(image_path, geojson_path, mask_path_out_gray, bin_conversion_func, mask_burn_val_key='burnValue', buffer_distance_meters=2, buffer_cap_style=1, dissolve_by='speed_m/s', bin_conversion_key='speed_mph', verbose=False):
    ...
    try:
        ...
        return []
    gdf_buffer = create_buffer_geopandas(inGDF, buffer_distance_meters=buffer_distance_meters, buffer_cap_style=buffer_cap_style, dissolve_by=dissolve_by, projectToUTM=True, verbose=verbose)
