...
from zoo.models import ScSeResNext101_9ch_Unet
import timeit
import cv2
import pandas as pd
...
if (__name__ == '__main__'):
    ...
    val_files = df[df['fold'].isin([fold, (fold + 4)])]['id'].values
    pred_folder = '/wdata/pred_101_9ch_oof_0'
    makedirs(pred_folder, exist_ok=True)
    snapshot_name = 'res101_9ch_fold_{0}_best_0'.format(fold)
    model = nn.DataParallel(ScSeResNext101_9ch_Unet()).cuda()
