...
def train():
    ...
    D_opt = tf.train.AdamOptimizer(0.0002, beta1=0.5).minimize(D_loss, var_list=D.var_list())
    G_opt = tf.train.AdamOptimizer(0.0002, beta1=0.5).minimize(G_loss, var_list=G.var_list())
    sess = tf.Session()
