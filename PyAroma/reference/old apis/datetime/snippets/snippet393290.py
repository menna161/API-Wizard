...
def simple_dataset_2() -> pd.DataFrame:
    ...
    data = {'id_join_key': ['a', 'b', 'c', 'd', 'e'], 'float_col': [0.1, 0.2, 0.3, 4, 5], 'int64_col': [1, 2, 3, 4, 5], 'string_col': ['a', 'b', 'c', 'd', 'e'], 'ts_1': [ts, (ts - timedelta(hours=4)), (ts - timedelta(hours=3)), (ts - timedelta(hours=2)), (ts - timedelta(hours=1))]}
