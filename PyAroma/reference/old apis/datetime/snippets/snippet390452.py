...
def generate_no_san_cert(domain, base_year, quiet=False):
    ...
    builder = CertificateBuilder({'country_name': 'US', 'state_or_province_name': 'Massachusetts', 'locality_name': 'Newbury', 'organization_name': 'Bad TLS Limited', 'common_name': 'no-san.{}'.format(domain)}, public_key)
