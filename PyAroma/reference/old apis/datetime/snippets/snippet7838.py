import pytest
from Acquire.ObjectStore import create_uid, validate_is_uid, get_datetime_now


def test_create_uid():
    validate_is_uid('2019-06-13T15:40:15.809684/a499a5b6')
    validate_is_uid('2019-06-13T15:40:42.784734/dc396049-ab04-4564-86d0-c78a3f43e22d')
